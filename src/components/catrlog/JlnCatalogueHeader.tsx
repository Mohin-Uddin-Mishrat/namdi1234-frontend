...
const JlnCatalogueHeader: React.FC = () => {
  const darkGreen = 'bg-[#004d2e]';

  return (
    <header className="bg-white shadow-lg border-b border-gray-200 font-sans mt-2 mx-2 md:mx-6 lg:mx-10">
      
      {/* 1. Main Dark Green Banner */}
      <div className={`${darkGreen} py-6 md:py-8 mx-2 md:mx-4`}>
...
export default JlnCatalogueHeader;
