...
import { IoLocationOutline, IoSearchOutline, IoNotificationsOutline } from "react-icons/io5";
  ...
  return (
    <nav className="bg-[#BFE099] w-full shadow-md sticky top-0 z-30">
      <div className=" mx-auto flex items-center h-16 sm:h-20 md:h-24 py-2 px-2 sm:px-4 md:px-6 lg:px-8">
       <Link to ="/"> <img src={logo} alt="logo" className="h-10 sm:h-12 md:h-14 lg:h-16 w-auto object-contain mr-3 flex-shrink-0" /></Link>
        ...
        <div className="flex-1 flex items-center gap-2 min-w-0">
          ...
          <button className="flex items-center justify-center px-3 h-9 md:h-10 rounded-full border border-[#015D38]  hover:text-white transition">
